...
// @RestController
// // CORS because React runs on a different port so in order to request access
// the
...
// // Assuming the columns are selected in the query, adjust the keys
// accordingly
...
// @PutMapping("/{id}")
// public ResponseEntity<Tenant> updateTenant(@PathVariable Integer id,
